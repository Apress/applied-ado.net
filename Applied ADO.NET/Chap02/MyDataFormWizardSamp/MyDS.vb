...
Public Class MyDS
    ...
    Private relationCustOrderRelation As DataRelation
    ...
    Friend Sub InitVars()
        ...
        End If
        Me.relationCustOrderRelation = Me.Relations("CustOrderRelation")
    End Sub
    
    Private Sub InitClass()
        Me.DataSetName = "MyDS"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/MyDS.xsd"
        ...
        fkc = New ForeignKeyConstraint("CustOrderRelation", New DataColumn() {Me.tableCustomers.CustomerIDColumn}, New DataColumn() {Me.tableOrders.CustomerIDColumn})
        Me.tableOrders.Constraints.Add(fkc)
        fkc.AcceptRejectRule = AcceptRejectRule.None
        fkc.DeleteRule = Rule.Cascade
        fkc.UpdateRule = Rule.Cascade
        Me.relationCustOrderRelation = New DataRelation("CustOrderRelation", New DataColumn() {Me.tableCustomers.CustomerIDColumn}, New DataColumn() {Me.tableOrders.CustomerIDColumn}, false)
        Me.Relations.Add(Me.relationCustOrderRelation)
    End Sub
    ...
    Public Class CustomersRow
        ...
        Public Function GetOrdersRows() As OrdersRow()
            Return CType(Me.GetChildRows(Me.Table.ChildRelations("CustOrderRelation")),OrdersRow())
        End Function
    End Class
    ...
    Public Class OrdersRow
        ...
        Public Property CustomersRow As CustomersRow
            Get
                Return CType(Me.GetParentRow(Me.Table.ParentRelations("CustOrderRelation")),CustomersRow)
            End Get
            Set
                Me.SetParentRow(value, Me.Table.ParentRelations("CustOrderRelation"))
            End Set
        End Property
