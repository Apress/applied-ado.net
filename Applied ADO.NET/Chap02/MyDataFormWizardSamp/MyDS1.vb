...
Public Class MyDS1
    ...
    Private relationCustOrderRelation1 As DataRelation
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As MyDS1 = CType(MyBase.Clone,MyDS1)
        cln.InitVars
        Return cln
    End Function
    ...
    Friend Sub InitVars()
        ...
        End If
        Me.relationCustOrderRelation1 = Me.Relations("CustOrderRelation1")
    End Sub
    
    Private Sub InitClass()
        Me.DataSetName = "MyDS1"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/MyDS1.xsd"
        ...
        fkc = New ForeignKeyConstraint("CustOrderRelation1", New DataColumn() {Me.tableCustomers.CustomerIDColumn}, New DataColumn() {Me.tableOrders.CustomerIDColumn})
        Me.tableOrders.Constraints.Add(fkc)
        fkc.AcceptRejectRule = AcceptRejectRule.None
        fkc.DeleteRule = Rule.Cascade
        fkc.UpdateRule = Rule.Cascade
        Me.relationCustOrderRelation1 = New DataRelation("CustOrderRelation1", New DataColumn() {Me.tableCustomers.CustomerIDColumn}, New DataColumn() {Me.tableOrders.CustomerIDColumn}, false)
        Me.Relations.Add(Me.relationCustOrderRelation1)
    End Sub
    ...
    Public Class CustomersRow
        ...
        Public Function GetOrdersRows() As OrdersRow()
            Return CType(Me.GetChildRows(Me.Table.ChildRelations("CustOrderRelation1")),OrdersRow())
        End Function
    End Class
    ...
    Public Class OrdersRow
        ...
        Public Property CustomersRow As CustomersRow
            Get
                Return CType(Me.GetParentRow(Me.Table.ParentRelations("CustOrderRelation1")),CustomersRow)
            End Get
            Set
                Me.SetParentRow(value, Me.Table.ParentRelations("CustOrderRelation1"))
            End Set
        End Property
