...
Public Class VideoTapeData
    ...
    Public Sub New()
        MyBase.New("VideoTape")
            ...
            Me.Columns.Add("CategoryID", Type.GetType("System.Decimal"))
...
Public Class VideoTapeDataAccess
    ...
    Public connectionString As String
        ...
        Protected loadCategory As SqlDataAdapter
    ...
    "Workstation ID=GRIMSAADO2K;"
            ...
            loadCategory = New SqlDataAdapter()

            loadCategory.SelectCommand = New SqlCommand("sp_VideoTapeLoadByCategoryID", New SqlConnection(connectionString))
            loadCategory.SelectCommand.CommandType = CommandType.StoredProcedure
            loadCategory.SelectCommand.Parameters.Add("@CategoryID", SqlDbType.Int, 0, "CategoryID")
        ...
        Public Function GetAllVideoTapesInCategory(ByVal catID As Integer) As VideoTape()
            Dim data As New VideoTapeData()
            loadCategory.SelectCommand.Parameters("@CategoryID").Value = catID
            loadCategory.Fill(data)
            Return GetVideoTapeArrayFromData(data)
        End Function
