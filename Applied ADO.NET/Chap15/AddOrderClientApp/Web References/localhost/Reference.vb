...
Namespace localhost
    ...
    Public Class Service1
        ...
        '<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/InsertOrder", RequestNamespace:="http://tempuri.org/", ResponseNamespace:="http://tempuri.org/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function InsertOrder(ByVal OrderInfo() As String) As Integer
            Dim results() As Object = Me.Invoke("InsertOrder", New Object() {OrderInfo})
            Return CType(results(0),Integer)
        End Function
        
        '<remarks/>
        Public Function BeginInsertOrder(ByVal OrderInfo() As String, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("InsertOrder", New Object() {OrderInfo}, callback, asyncState)
        End Function
        
        '<remarks/>
        Public Function EndInsertOrder(ByVal asyncResult As System.IAsyncResult) As Integer
            Dim results() As Object = Me.EndInvoke(asyncResult)
            Return CType(results(0),Integer)
        End Function
    End Class
